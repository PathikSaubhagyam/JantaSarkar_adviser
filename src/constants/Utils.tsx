...
export const BASE_URL = 'https://jantasarkar.saubhagyam.org/'; //live
// export const BASE_URL = 'http://192.168.1.10:8000/'; //local

// export const IMAGE_BASE_URL = 'http://192.168.1.17:8080/spibo/storage/';
export const IMAGE_BASE_URL = 'https://jantasarkar.saubhagyam.org/';
